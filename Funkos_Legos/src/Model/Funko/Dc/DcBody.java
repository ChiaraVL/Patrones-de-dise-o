...
public class DcBody implements Body {
    ...
    public DcBody(){
        DC = new ArrayList<>();
        DC.add(new ImageIcon("Imagenes/Funkos/Dc/Tronco/1.jpg"));
        DC.add(new ImageIcon("Imagenes/Funkos/Dc/Tronco/2.jpg"));
        DC.add(new ImageIcon("Imagenes/Funkos/Dc/Tronco/3.jpg"));
        DC.add(new ImageIcon("Imagenes/Funkos/Dc/Tronco/4.jpg"));
        DC.add(new ImageIcon("Imagenes/Funkos/Dc/Tronco/5.jpg"));
    }
